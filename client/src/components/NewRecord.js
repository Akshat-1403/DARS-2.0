                ...
                <div className="card-content">
                  <form onSubmit={this.onSubmit}>
                    <div className="input-field">
                      <input type="text" id="recodId" onChange={(evt) => { this.setState({...this.state, record_id : evt.target.value })}} required />
                      <label htmlFor="email">Student ID</label>
                    </div>
                    <div className="input-field">
                      <input type="text" id="address" onChange={(evt) => this.setState({...this.state, address:evt.target.value}) } required />
                      <label htmlFor="email">Institute Address</label>
                    </div>
                    <div className="input-field">
                      <input value={this.state.timestamp} type="text" id="timestamp" readOnly onChange={(evt) => this.setState({...this.state, timestamp:evt.target.value}) } required />
                      {/* <label htmlFor="email">Time Stamp</label> */}
                    </div>
                    <div className="input-field">
                      <input type="text" id="offCode" onChange={(evt) => this.setState({...this.state, record_code:evt.target.value}) } required />
